...
export default function EmployeePage() {
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#e7ecef] pb-[7px]">
          ...
          <div className="flex items-start gap-8 md:flex-col">
            ...
            <div className="mt-[25px] mx-[30px] ml-[-55px]  flex flex-1 flex-col items-end gap-3.5 rounded-[20px] bg-[#ffffff] p-[13px] md:self-stretch md:p-5">
              <Input
                ...
                prefix={<Img src="images/img_search.svg" alt="search" className="h-[24px] w-[24px] cursor-pointer" />}
                suffix={
                  searchBarValue?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue("")} height={24} width={24} fillColor="#16141bff" />
                  ) : null
                }
                className="mt-[22px] flex h-[50px] w-[32%] items-center justify-center gap-2.5 rounded-[10px] border border-solid border-[#a2a1a819] pl-4 pr-[35px] text-base font-light text-[#16151c33] sm:pr-5"
              />
              <div className="mb-[163px] grid grid-cols-2 gap-5 self-stretch md:grid-cols-1">
                {/* branch info section */}
                ...
                <div className="flex w-full flex-col items-start rounded-[10px] border border-solid border-[#a2a1a833] p-5">
                  <div className="flex items-center justify-between gap-5 self-stretch">
                    <div className="flex flex-col items-start justify-center gap-[3px]">
                      <Heading as="h4" className="mt-[5px]">Team & Group</Heading>
                      <Text size="s" as="p" className="mb-[13px]">
                  ...
                  <div className="mb-[29px] mt-[21px] flex w-[40%] flex-col gap-[17px] md:w-full">
                    ...
                    <Link to ="/create_team" className="bg-[#148cfc] rounded-[20px] p-[10px] w-80 ml-[120px] mt-[30px] text-white text-center">
                    Create Team & Group
                    </Link>
                  </div>
                </div>
