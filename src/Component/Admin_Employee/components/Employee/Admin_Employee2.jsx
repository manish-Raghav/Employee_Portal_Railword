...
const mybt = () =>{
  ...
  return (
    ...
    <section className=' w-[76vw] z-40 relative left-[10rem] top-8 ml-[8%]  p-3 '>
    {
       <div className='h-[40rem] bg-white w-auto relative top-8  bottom-3  rounded-lg shadow-lg'>
       {/* <div className='underline underline-offset-4 text-2xl'>Raipur Branch</div> */}
...
export default Admin_Employee2
