...
// import { Front } from 'components/Data/Fronend';
// import { Back } from 'components/Data/Backend';
const EmpData = ({data}) => {
              ...
              {currentEmployees.map((employee, index) => (
                <tr key={employee.id} className="border-b ml-0">
                  ...
                  <td className="py-2 px-4  flex items-center">
                    ...
                    <img src={employee.img} alt={employee.name} className="w-10 h-10 rounded-full mr-3 " style={{display:'flex', flexDirection:'row'}}  />
                    {employee.name}
                    </Link>
                  </td>
                  ...
                  <td className="py-2 px-4 flex space-x-3">
                    <button className="text-gray-600 text-xl hover:bg-white">
