...
const Attendance = () => {
    ...
    //         <div className="absolute w-[1066px] h-[850px] bg-white rounded-lg top-[80px] left-[80px] p-4 shadow-lg">
    ...
    return (
        <div className=" w-full  h-[850px] mx-auto z-40  left-[2rem] top-16  p-3 ">
            ...
            <div className="absolute w-[calc(100%-352px)] h-[850px] bg-white rounded-lg top-[160px] left-[352px] p-4 shadow-lg">
                <h1 className="text-[23px] text-blue-950 font-medium mb-4">Attendance Overview</h1>
                <div className="flex mb-4">
                    <div className="mr-4 flex items-center gap-2">
                        <label className="block text-sm font-medium text-gray-700">From</label>
