...
<>
                                                     {/* Navbar */}
<div className='bg-red-500 lg:w-full lg:h-[64px] text-white'></div>
                                                     {/* maindiv */}
<div className='flex justify-between' >
                                                      {/* slidebar  */}
  <div className=' text-white   lg:h-[680px]  lg:w-[320px] bg-gray-500 '></div>
                                                       {/* FormDiv */}
<div className="min-h-screen  bg-gray-300 md:h-1/4 flex  justify-center p-5">   

<div className="flex flex-col lg:w-[95%]  md:h-[600px]  bg-white  md:flex-row  m-1 shadow-lg rounded-lg overflow-hidden">

  <div className="md:w-1/2    lg:p-10 bg-gray-200 p-4 text-blue-600">

    <h2 className="text-3xl font-bold mb-4">Fill the form to submit your feedback</h2>
